...
from nerfstudio.field_components.field_heads import (
    DensityFieldHead, FieldHead, FieldHeadNames, RGBFieldHead,
    UncertaintyFieldHead, TransientRGBFieldHead, TransientDensityFieldHead
)
...
class NeRFWField(Field):
    ...
    def get_outputs(
        ...
        directions = ray_samples.frustums.directions  # get_normalized_directions()
        ...
        h = torch.cat(
            ...
            + (
                [embedded_appearance] if embedded_appearance is not None else []
            ),
            dim=-1,
        )
